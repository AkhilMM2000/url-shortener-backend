...
import { MongoShortUrlRepository } from '../database/repositories/MongoShortUrlRepository';
...
export function setupDI() {
  ...
  container.register(DI_TOKENS.IShortUrlRepository, { useClass: MongoShortUrlRepository });
